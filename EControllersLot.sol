...
import "@openzeppelin/contracts/access/Ownable.sol";
    ...
    interface IManagment{
        function linkESControllerstoLot(uint256, uint256[3] memory) external;
    }

contract ESControllersLOT is ERC721URIStorage, Ownable{
    uint public tokenCount;
    IManagment public Management;
    constructor () ERC721("Electronic Speed Controllers LOT", "ESCLOT"){
    ...
    function mint(string memory _tokenURI, uint256[3] memory _childIDs, address _LotCreator) external onlyManagementSmartContract returns(uint, string memory) {
        ...
        Management.linkESControllerstoLot(tokenCount, _childIDs);
