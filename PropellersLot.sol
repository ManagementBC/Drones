...
import "@openzeppelin/contracts/access/Ownable.sol";
    ...
    interface IManagment{
        function linkPropellerstoLot(uint256, uint256[3] memory) external;
    }

contract PropellersLOT is ERC721URIStorage, Ownable{
    uint public tokenCount;
    IManagment public Management;
    constructor () ERC721("Propellers LOT", "PPLOT"){
    ...
    function mint(string memory _tokenURI, uint256[3] memory _childIDs, address _LotCreator) external onlyManagementSmartContract returns(uint, string memory) {
        ...
        Management.linkPropellerstoLot(tokenCount, _childIDs);
