...
contract PropellersNFT is ERC721URIStorage, Ownable{
    uint public tokenCount;
    constructor () ERC721("Propellers NFTs", "PP"){} // The constructor uses the imported ERC721 contract which requires two inputs in its constructor, the name and symbol of the NFT
